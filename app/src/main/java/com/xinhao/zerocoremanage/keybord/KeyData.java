...
import com.xinhao.zerocoremanage.R;
import com.xinhao.zerocoremanage.utils.SaveData;
...
public class KeyData implements View.OnClickListener {
    ...
    public static View getView() {
        return UUtils.getViewLay(R.layout.key_bot_pc);
    }
    ...
    private void initKeyView(View view) {
        ...
        vibrator = (Vibrator) UUtils.getEngineContext().getSystemService(UUtils.getEngineContext().VIBRATOR_SERVICE);
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                switch (event.getAction()) {
                    ...
                    case MotionEvent.ACTION_DOWN:
                        ...
                        key_back.setBackground(UUtils.getEngineContext().getResources().getDrawable(R.drawable.shape_key_back_lan));
                        key_back.setBackground(UUtils.getEngineContext().getResources().getDrawable(R.drawable.shape_key_back_lan));
                    ...
                    case MotionEvent.ACTION_UP:
                        key_back.setBackground(UUtils.getEngineContext().getResources().getDrawable(R.drawable.shape_key_back));
                        key_back.setBackground(UUtils.getEngineContext().getResources().getDrawable(R.drawable.shape_key_back));
                        isLong = false;
                        break;
        ...
        key_W.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                switch (event.getAction()) {
                    ...
                    case MotionEvent.ACTION_DOWN:
                        key_W.setBackground(UUtils.getEngineContext().getResources().getDrawable(R.drawable.shape_key_back_lan));
                        key_W.setBackground(UUtils.getEngineContext().getResources().getDrawable(R.drawable.shape_key_back_lan));

                        if (isAlt) {
                            isAlt = false;
                            mTerminalView.sendTextToTerminalAlt("w", true);
                            key_at_l.setBackground(UUtils.getEngineContext().getResources().getDrawable(R.drawable.shape_key_back));
                            key_at_r.setBackground(UUtils.getEngineContext().getResources().getDrawable(R.drawable.shape_key_back));
                        ...
                        if (isCtrl) {
                            ...
                            key_ctrl.setBackground(UUtils.getEngineContext().getResources().getDrawable(R.drawable.shape_key_back));
                            key_ctrl_r.setBackground(UUtils.getEngineContext().getResources().getDrawable(R.drawable.shape_key_back));
                            return true;
                        }
                    ...
                    case MotionEvent.ACTION_UP:
                        key_W.setBackground(UUtils.getEngineContext().getResources().getDrawable(R.drawable.shape_key_back));
                        key_W.setBackground(UUtils.getEngineContext().getResources().getDrawable(R.drawable.shape_key_back));
                        isLong = false;
                        break;
        ...
        key_A.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                switch (event.getAction()) {
                    ...
                    case MotionEvent.ACTION_DOWN:
                        key_A.setBackground(UUtils.getEngineContext().getResources().getDrawable(R.drawable.shape_key_back_lan));
                        key_A.setBackground(UUtils.getEngineContext().getResources().getDrawable(R.drawable.shape_key_back_lan));
                    ...
                    case MotionEvent.ACTION_UP:
                        key_A.setBackground(UUtils.getEngineContext().getResources().getDrawable(R.drawable.shape_key_back));
                        key_A.setBackground(UUtils.getEngineContext().getResources().getDrawable(R.drawable.shape_key_back));
                        isLong = false;
                        break;
        ...
        key_S.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                switch (event.getAction()) {
                    ...
                    case MotionEvent.ACTION_DOWN:
                        key_S.setBackground(UUtils.getEngineContext().getResources().getDrawable(R.drawable.shape_key_back_lan));
                        key_S.setBackground(UUtils.getEngineContext().getResources().getDrawable(R.drawable.shape_key_back_lan));
                    ...
                    case MotionEvent.ACTION_UP:
                        key_S.setBackground(UUtils.getEngineContext().getResources().getDrawable(R.drawable.shape_key_back));
                        key_S.setBackground(UUtils.getEngineContext().getResources().getDrawable(R.drawable.shape_key_back));
                        isLong = false;
                        break;
        ...
        key_D.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                switch (event.getAction()) {
                    ...
                    case MotionEvent.ACTION_DOWN:
                        key_D.setBackground(UUtils.getEngineContext().getResources().getDrawable(R.drawable.shape_key_back_lan));
                        key_D.setBackground(UUtils.getEngineContext().getResources().getDrawable(R.drawable.shape_key_back_lan));
                    ...
                    case MotionEvent.ACTION_UP:
                        key_D.setBackground(UUtils.getEngineContext().getResources().getDrawable(R.drawable.shape_key_back));
                        key_D.setBackground(UUtils.getEngineContext().getResources().getDrawable(R.drawable.shape_key_back));
                        isLong = false;
                        break;
        ...
        if ("true".equals(vibrator)) {
            vibrator_key.setBackground(UUtils.getEngineContext().getResources().getDrawable(R.drawable.shape_key_back_lan));

            isVibrator = true;

        } else {

            vibrator_key.setBackground(UUtils.getEngineContext().getResources().getDrawable(R.drawable.shape_key_back));
            isVibrator = false;
        }
        ...
        switch (v.getId()) {
            ...
            case R.id.key_daxiaoxie:
                ...
                if (isCaps) {
                    ...
                    key_daxiaoxie.setBackground(UUtils.getEngineContext().getResources().getDrawable(R.drawable.shape_key_back_lan));

                } else {
                    key_daxiaoxie.setBackground(UUtils.getEngineContext().getResources().getDrawable(R.drawable.shape_key_back));
                }
            ...
            case R.id.key_shift:
                ...
                isShift = !isShift;
                if (isShift) {
                    key_shift.setBackground(UUtils.getEngineContext().getResources().getDrawable(R.drawable.shape_key_back_lan));
                    key_W.setText("↑");
                    key_A.setText("←");
                    key_D.setText("→");
                    key_S.setText("↓");
                } else {
                    key_shift.setBackground(UUtils.getEngineContext().getResources().getDrawable(R.drawable.shape_key_back));
                    key_W.setText("W");
                    key_A.setText("A");
                    key_D.setText("D");
                    key_S.setText("S");
            ...
            case R.id.key_ctrl:
                ...
                if (isCtrl) {
                    key_ctrl.setBackground(UUtils.getEngineContext().getResources().getDrawable(R.drawable.shape_key_back_lan));
                    key_ctrl_r.setBackground(UUtils.getEngineContext().getResources().getDrawable(R.drawable.shape_key_back_lan));
            ...
            case R.id.key_at_l:
                ...
                isAlt = !isAlt;
                if (isAlt) {
                    key_at_l.setBackground(UUtils.getEngineContext().getResources().getDrawable(R.drawable.shape_key_back_lan));
                    key_at_r.setBackground(UUtils.getEngineContext().getResources().getDrawable(R.drawable.shape_key_back_lan));
